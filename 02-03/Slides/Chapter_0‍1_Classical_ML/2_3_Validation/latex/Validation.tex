...
\begin{figure}
				...
				\centering
				\includegraphics[width=10cm]{Figs/Validation.png}}
\end{figure}
...
\begin{figure}
				...
				\centering
				\includegraphics[width=8cm]{Figs/Validation.png}}
\end{figure}
\begin{itemize}
...
\begin{figure}
				...
				\centering
				\includegraphics[width=8cm,height=4cm]{Figs/LOOCV.png}}
\end{figure}
\begin{itemize}
\item Pros \begin{itemize}
\item Lower bias
...
\begin{figure}
				\href{https://zitaoshen.rbind.io/project/machine_learning/machine-learning-101-cross-vaildation/}{
				\centering
				\includegraphics[width=9cm, height=4cm]{Figs/K-Fold Cross Validation.jpg}}
\end{figure}
\begin{itemize}
\item Pros \begin{itemize}
...
\begin{itemize}
\item Hyperparameter optimization or tuning is the problem of choosing as to optimal hyperparameters for a learning algorith.
\item A hyperparameter is a parameter whose value is used to control the learning process.
\item By contrast, the values of other parameters of the model are learned.
\item Hyperparameter optimization finds a tuple of hyperparameters that yields an optimal model which minimizes a predefined loss function on given independent data.
Various algorithms of hyperparameter optimization:
\begin{itemize}
\item Grid search
\item Random Search
...
\end{itemize}
\item Importanthyperparametertuningpackages: \begin{itemize}
\item Hyperopt
\item Optuna
\item Skopt
